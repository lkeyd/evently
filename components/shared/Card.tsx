...
const Card = ({ event, hasOrderLink, hidePrice }: CardProps) => {
  ...
  return (
    <div className="group relative flex min-h-[380px] w-full max-w-[400px] flex-col overflow-hidden roundex-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
      <div
      ...
      {isEventCreator && !hidePrice && (
        <div className="absolute right-2 top-2 flex flex-col gap-4 rounded-xl bg-white p-3 shadow-sm transition-all">
          ...
          <DeleteConfirmation eventId={event._id}></DeleteConfirmation>
        </div>
      )}
      <Link
